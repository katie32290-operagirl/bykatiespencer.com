      ...
      <div className={`${PAD} py-[clamp(64px,9vw,90px)]`} style={{ background: C.cream }}>
        <div className="mx-auto grid max-w-[1180px] items-start gap-[clamp(36px,5vw,64px)] md:grid-cols-[400px_1fr]">
          <div>
            ...
            <img src="/on/katie-connect.jpg" alt="Katie Spencer" className="block w-full object-cover" style={{ height: "clamp(380px,52vw,480px)", objectPosition: "center 18%", border: `1.5px solid ${C.ox}` }} />
